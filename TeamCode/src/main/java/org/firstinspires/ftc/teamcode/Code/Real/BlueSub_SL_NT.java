...
public class BlueSub_SL_NT extends CommandOpMode {
   ...
   //  private final Pose align3 = new Pose(65, 63, Math.toRadians(180));
    // private final Pose pickUpThird = new Pose(37, 63, Math.toRadians(180));
    // private final Pose park = new Pose(58.2, 61, Math.toRadians(180));
    ...
    public void initialize() {
        ...
        schedule(new SequentialCommandGroup(
                ...
                new FollowPathCommand(follower, thirdSet)
