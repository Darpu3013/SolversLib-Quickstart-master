...
@TeleOp(name="TurretKeepTryingPID")
public class TurretKeepTrying extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double newTargetAngle = currentAngle + pidOutput;
            newTargetAngle = Math.max(-150, Math.min(150, newTargetAngle));
            ...
            telemetry.addData("New Target Angle", newTargetAngle);
            telemetry.update();
        }
    }
}
